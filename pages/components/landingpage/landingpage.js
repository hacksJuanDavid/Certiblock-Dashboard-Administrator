...
import { Slicksider, Slicksiderwithdata } from "../../../shared/data/landingpagedata/landingpagedata";
// import Navbar1 from "../../../shared/data/landingpagedata/navbar";
import dynamic from "next/dynamic";
const Navbar1 = dynamic(() => import('../../../shared/data/landingpagedata/navbar'), { ssr: false });
            ...
            <Navbar expand="lg" className="main-header side-header hor-header" style={{ marginBottom: "-64px" }}>
              <Container fluid className="main-container">
                <div className="main-header-left">
                  <Link href="#" 
                    ><a className="main-header-menu-icon" onClick={() => Sidebartoggled()} id="mainSidebarToggle"><span></span></a></Link>
                  <div className="hor-logo">
                    <Link href="#" >
                      <a className="main-logo">
                      <img src={icon.src} className="header-brand-img desktop-logo"
                        alt="logo" />
                      <img src={iconlight.src} className="header-brand-img desktop-logo-dark"
                        alt="logo" />
                      </a>
                    </Link>
                  </div>
                ...
                <div className="main-header-center">
                  <div className="responsive-logo">
                    <Link href={`/components/dashboard/dashboard`}><a><img src={logo.src} className="mobile-logo"
                      alt="lo/o" /></a></Link>
                    <Link href={`/components/dashboard/dashboard`}><a><img src={logolight.src} className="mobile-logo-dark"
                      alt="logo" /></a></Link>
                  </div>
                </div>
                      ...
                      <div className="d-flex order-lg-2 ms-auto">
                        <div className="header-nav-right p-3">
                          <Link href="#" target="_blank">
                                <a className="btn ripple btn-min w-sm btn-outline-primary me-2">
                                New User
                                </a>
                          </Link>
                          <Link href="#">
                                <a className="btn ripple btn-min w-sm btn-primary me-2"
                            target="_blank">
                                Login
                                </a>
                          </Link>
                    ...
                    <Row>
                      ...
                      <div className="navbar main-sidemenu px-0">
                        <Link href={`/components/dashboard/dashboard`}>
                          <a className="main-logo">
                          <img src={logo.src} className="header-brand-img desktop-logo"
                            alt="logo" />
                          <img src={logolight.src}
                        ...
                        <div className="header-nav-right d-none d-lg-block">
                          <Link href="#" >
                                <a className="btn ripple btn-min w-sm btn-secondary me-2"
                            target="_blank">
                                New User
                                </a>
                          </Link>
                          <Link href="#" >
                                <a className="btn ripple btn-min w-sm btn-info me-2"
                            target="_blank">
                                Login
                                </a>
                          </Link>
                ...
                <Container className="px-sm-0">
                  <Row>
                    <Col xl={6} lg={6} className="animation-zidex pos-relative">
                      ...
                      <Link href="https://themeforest.net/item/dashlead-bootstrap-5-admin-dashboard-template/35183671"
                        ><a target="_blank" className="btn ripple btn-min w-lg mb-3 me-2 btn-light"><i
                          className="fe fe-play me-2"></i> 
                          
                          Get Started
                          </a>
                      </Link>
                      <Link href="https://themeforest.net/user/spruko/portfolio"
                        ><a className="btn ripple btn-min w-lg btn-outline-light mb-3 me-2"><i
                          className="fe fe-eye me-2"></i> 
                          Discover More
                          </a>
                      </Link>
                    </Col>
...
C431.3,1830.2,378.4,1777.3,378.4,1712z" />
                                      ...
                                      <Card className=" bg-primary-transparent bg-transparent border p-0 reveal">
                                        ...
                                        {isFirstCollapsed ? (
                                          <Card.Body className="pt-0">
                                            ...
                                            <Link href="#" target="_blank">
                                              <a className="btn btn-outline-primary tx-13">
                                                Click
                                              here
                                              </a>
                                              </Link>
                                      ...
                                      <Card
                                        ...
                                        {is2Collapsed ? (
                                          <Card.Body className="pt-0">
                                            ...
                                            <Link href="#" target="_blank" >
                                                <a className="btn btn-outline-success tx-13">
                                                Click
                                              here
                                                </a>
                                              </Link>
                                      ...
                                      <Card
                                        ...
                                        {is3tCollapsed ? (
                                          <Card.Body className="pt-0">
                                            ...
                                            <Link href="#" target="_blank" >
                                              <a className="btn btn-outline-info tx-13">
                                                Click
                                              here
                                                </a>  
                                              </Link>
                                      ...
                                      <Card
                                        ...
                                        {is4Collapsed ? (
                                          <Card.Body className="pt-0">
                                            ...
                                            <Link href="#" target="_blank" >
                                              <a className="btn btn-outline-secondary tx-13">
                                                Click
                                              here
                                              </a>
                                              </Link>
                                      ...
                                      <Card
                                        ...
                                        {is5Collapsed ? (
                                          <Card.Body className="pt-0">
                                            ...
                                            <Link href="#" target="_blank"  >
                                              <a className="btn btn-outline-warning tx-13">
                                                Click
                                              here
                                              </a>
                                              </Link>
                                  ...
                                  {is10Collapsed ? (
                                    ...
                                    <Card.Body className="pt-0">
                                      ...
                                      <Link href="#" ><a target="_blank"
                                        className="btn btn-outline-warning tx-13">Click here</a></Link>
                                    </Card.Body>
                                  ) : null}
                                </Card>
                              </Col>
                                ...
                                <Card
                                  ...
                                  {is11Collapsed ? (
                                    ...
                                    <Card.Body className="pt-0">
                                      ...
                                      <Link href="#"><a  target="_blank"
                                        className="btn btn-outline-danger tx-13">Click here</a></Link>
                                    </Card.Body>
                                  ) : null}
                                </Card>
                              </Col>
                  ...
                  <div className="demo-screen-skin bg-primary">
                    <Container className="text-center text-white px-5 px-md-0">
                      <Row id="demo">
                        <Col lg={6}>
                          <div className="feature-1 border-0"> <Link href="#"><a></a></Link>
                            ...
                            <h6 className="mb-0">Support : <Link href="mailto:support@spruko.com" 
                            ><a className="text-white pos-relative">support@spruko.com</a></Link></h6>
                          </div>
                        </Col>
                        <Col lg={6} className=" mt-5 mt-xl-0 mt-lg-0">
                          <div className="feature-1 border-0"> <Link href="#"><a></a></Link>
                            ...
                            <p className="mb-1 text-white">Please feel free to ask any questions before making
                              the purchase.</p>
                            <h6 className="mb-0">Ask : <Link href="mailto:support@spruko.com" 
                            ><a className="text-white pos-relative">support@spruko.com</a></Link>
                            </h6>
                          </div>
                        </Col>
                      </Row>
                        ...
                        <Row>
                          ...
                          <Col lg={2} sm={6} md={4} className=" reveal revealleft">
                            ...
                            <ul className="mb-5 mb-lg-0 ps-0">
                              ...
                              <li><Link href="#"><a>Elements</a></Link></li>
                              <li><Link href="#"><a>Forms</a></Link></li>
                              <li><Link href="#"><a>Charts</a></Link></li>
                              <li><Link href="#"><a>Tables</a></Link></li>
                              <li><Link href="#"><a>Other Pages</a></Link></li>
                            </ul>
                          </Col>
                          <Col lg={2} sm={6} md={4} className=" reveal revealleft">
                            <h6>Information</h6>
                            <ul className="mb-5 mb-lg-0 ps-0">
                              ...
                              <li><Link href="#"><a>Terms and Services</a></Link></li>
                            </ul>
                          </Col>
                          <Col lg={4} sm={12} md={4} className="reveal revealleft">
                            <div>
                              <Link href="index.html"><a><img loading="lazy" alt="" className="logo mb-3"
                                src={logolight.src} /></a></Link>
                      ...
                      <footer className="main-footer px-0 text-center">
                        <Row>
                          <Col md={12} sm={12}>
                            ...
                            <Link href="#"><a>Spruha</a></Link>.Designed with <span className="fa fa-heart text-danger"></span> by
                            <Link href="#"><a>Spruko</a></Link> All rights reserved.
                          </Col>
                        </Row>
                      </footer>
                    </Card.Body>
