...
const AprobacionesColecciones = () => {
    return (
        <div>
            <h1>Aprobar Colecciones</h1>
            <Col xl={12} className="col-xl-12">
                <Card className="custom-card mg-b-20" id="tabs-style2">
                    <Card.Header className="d-sm-flex  justify-content-between align-items-center">
                        <div className="main-content-label mg-b-5">Colecciones de no aprobadas
                                                                                                ...
                                                                                                <div>
                                                                                                    <div className="btn-icon-list">
                                                                                                        <Button variant="primary">
                                                                                                            <i className="fe fe-upload"> Aprobar Coleccion</i>
                                                                                                        </Button>
                                                                                                    </div>
                                                                                                </div>
...
export default AprobacionesColecciones