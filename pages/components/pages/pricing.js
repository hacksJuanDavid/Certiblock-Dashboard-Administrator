      ...
      <Col lg={3} sm={6}>
        <Card className="card-pricing custom-card">
          ...
          <Card.Body className=" pt-0 text-center">
            ...
            <Link href="#" >
              <a className="btn ripple btn-light mb-2">
			  Order Now
			  </a>
            </Link>
          </Card.Body>
      ...
      <Col lg={3} sm={6}>
        <Card className="card-pricing2 custom-card">
          ...
          <Card.Body className=" pt-0 text-center">
            ...
            <Link href="#" >
              <a className="btn ripple btn-primary mb-2">
			  Order Now
			  </a>
            </Link>
          </Card.Body>
      ...
      <Col sm={12} md={4}>
        <Card className="custom-card card-pricing">
          ...
          <Card.Body className=" pt-0 text-center">
            ...
            <Link href="#" >
              <a className="btn ripple btn-outline-primary mb-3">
			  Purchase Now
			  </a>
            </Link>
          </Card.Body>
      ...
      <Col sm={12} md={4}>
        <Card className="custom-card card-pricing">
          ...
          <Card.Body className=" pt-0 text-center">
            ...
            <Link href="#" >
              <a className="btn ripple btn-outline-secondary mb-3">
			  Purchase Now
			  </a>
            </Link>
          </Card.Body>
      ...
      <Col sm={12} md={4}>
        <Card className="custom-card card-pricing">
          ...
          <Card.Body className=" pt-0 text-center">
            ...
            <Link href="#" >
              <a className="btn ripple btn-outline-info mb-3"> 
			  Purchase Now
			  </a>
            </Link>
          </Card.Body>
                          ...
                          <Card className="overflow-hidden">
                            <div className="text-center card-pricing pricing1">
                              ...
                              <Card.Footer className="text-center">
                                ...
                                >
									<a className="btn ripple btn-primary btn-block">
                                  Buy Now
									</a>
                                </Link>
                              </Card.Footer>
                          ...
                          <Card className="overflow-hidden">
                            <div className="text-center card-pricing pricing1">
                              ...
                              <Card.Footer className="text-center">
                                ...
                                >
									<a className="btn ripple btn-secondary btn-block">
                                  Buy Now
									</a>
                                </Link>
                              </Card.Footer>
                          ...
                          <Card className="overflow-hidden">
                            <div className="text-center card-pricing pricing1">
                              ...
                              <Card.Footer className="text-center">
                                ...
                                >
									<a className="btn ripple btn-info btn-block">
                                  Buy Now
									</a>
                                </Link>
                              </Card.Footer>
                            ...
                            <div className="text-center card-pricing pricing1">
                              ...
                              <Card.Footer className="text-center">
                                <Link
                                  href="#"
                                >
									<a className="btn ripple btn-success btn-block">
                                  Buy Now
									</a>
                                </Link>
                              </Card.Footer>
