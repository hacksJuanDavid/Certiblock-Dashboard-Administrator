            ...
            <Col xl={6} lg={6} md={12} sm={12}>
              <div className="mt-5">
                ...
                <Link href="#"  role="button">
                  <a className="btn ripple btn-primary btn-sm">
					        Contact Us
                  </a>
                </Link>
              </div>
            ...
            <Card.Body>
              ...
              <div className="text-center mt-3">
                <Link href="#" target="_blank" >
                  <a className="btn btn-sm ripple bg-primary-transparent text-primary rounded-circle me-1">
					<i className="mdi mdi-facebook"></i>
					</a>
                </Link>
                <Link href="#" target="_blank" >
				<a className="btn btn-sm ripple bg-danger-transparent text-danger rounded-circle me-1">
                  <i className="mdi mdi-google"></i>
				</a>
                </Link>
                <Link href="#" target="_blank" >
				<a className="btn btn-sm ripple bg-info-transparent text-info rounded-circle">
