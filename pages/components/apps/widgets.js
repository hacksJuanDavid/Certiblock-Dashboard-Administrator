        ...
        <Col md={6} sm={6} xl={3}>
          <Card className="custom-card">
            <Card.Body className="user-card text-center">
              ...
              <Link href="#" >
                <a className="btn ripple btn-primary mt-3">
                View Profile
                </a>
              </Link>
            </Card.Body>
        ...
        <Col md={6} sm={6} xl={3}>
          <Card className="custom-card">
            <Card.Body className="user-card text-center">
              ...
              <Link href="#" >
                <a className="btn ripple btn-primary mt-3">View Profile</a>
              </Link>
            </Card.Body>
          </Card>
        </Col>
              ...
              <Card className="card custom-card our-team">
                <Card.Body>
                  ...
                  <div className="contact-info mb-0 text-center">
                    <Link href="#" >
                      <a className="contact-icon border text-primary me-2"><i className="fab fa-facebook-f"></i></a>
                    </Link>
                    <Link href="#" >
                      <a className="contact-icon border text-primary me-2">
