...
import { Tab, Card, Col, Row, Button } from "react-bootstrap";
...
const TabCollectionCreate = () => {
    return (
        <div>
            <h1>Crear Colecciones</h1>
            <Col xl={12} className="col-xl-12">
                <Card className="custom-card mg-b-20" id="tabs-style2">
                    <Card.Header className="d-sm-flex  justify-content-between align-items-center">
                        <div className="main-content-label mg-b-5">Creador de colecciones
                            <p className="text-muted card-sub-title">
                                Para la empresa: <b> Universidad Eafit</b>
                            </p>
                        </div>
                    </Card.Header>
                    <Card.Body>
                                                                ...
                                                                <Card className="custom-card">
                                                                    <Card.Body>
                                                                        <div>
                                                                            ...
                                                                            <p className="text-muted card-sub-title">
                                                                                Tabla de para creacion de la coleccion: <b>Coleccion 1 universidad eafit</b>
                                                                            </p>
                                                                        </div>
                                                                            ...
                                                                            <Row className="row-sm">
                                                                                <Col lg={12}>
                                                                                    <Card className="custom-card overflow-hidden">
                                                                                        <Card.Body>
                                                                                            <div>
                                                                                                <h6 className="main-content-label mb-1">Crear Coleccion Graduados 2023</h6>
                                                                                                <p className="text-muted card-sub-title">
                                                                                                    Universidad Eafit
                                                                                                </p>
                                                                                            </div>
                                                                                                    ...
                                                                                                    <Col md={6} sm={6} xl={3}>
                                                                                                        <Card className="custom-card">
                                                                                                            <Card.Body className="text-center">
                                                                                                                ...
                                                                                                                <h3 className="mb-0">Adm-Universidad-eafit</h3>
                                                                                                            </Card.Body>
                                                                                                        </Card>
                                                                                                    </Col>
                                                                                                </Row>
                                                                                                ...
                                                                                                <div>
                                                                                                    <div className="btn-icon-list">
                                                                                                        <Button variant="primary">
                                                                                                            <i className="fe fe-upload"> Subir Coleccion</i>
                                                                                                        </Button>
                                                                                                    </div>
                                                                                                </div>
...
export default TabCollectionCreate