              ...
              <div className="predefined_styles">
                <div className="swichermainleft text-center">
                  <div className="p-3 d-grid gap-2">
                    <Link href="https://nextjs.spruko.com/spruha/" className="btn btn-primary rounded-10 mt-0"><a className="btn btn-primary rounded-10 mt-0">View Demo</a></Link>
                    <Link href="#" className="rounded-10 btn btn-secondary"><a className="rounded-10 btn btn-secondary">Buy Now</a></Link>
                    <Link href="https://themeforest.net/user/spruko/portfolio" className="rounded-10 btn btn-info"><a className="rounded-10 btn btn-info">Our Portfolio</a></Link>
                  </div>
                </div>
