                      ...
                      {Item.Items.map((menuItem, i) => (
                        ...
                        >
                          ...
                          {menuItem.type === "link" ? (
                            ...
                            >
                              <a className={`nav-link ${menuItem.selected ? " active" : ""}`}>
                                <span className="shape1"></span>
                                <span className="shape2"></span>
                                <i
                                  className={`${menuItem.icon} ${menuIcontype} menu-icon`}
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    {childrenItem.type === "link" ? (
                                      ...
                                      >
                                        <a className={`nav-sub-link ${menuItem.selected ? " active" : ""}`}>{childrenItem.title}</a>
                                      </Link>
                                    ) : (
                                      ""
                                    )}
                                          ...
                                          (childrenSubItem, key) => (
                                            ...
                                            >
                                              {childrenSubItem.type ===
                                                ...
                                                >
                                                  <a className={`nav-sub-link ${location.pathname == childrenSubItem.path ? " active" : "" }`} >{childrenSubItem.title}</a>
                                                </Link>
                                              ) : (
                                                ""
                                              )}
